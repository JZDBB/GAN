...
the original GAN paper : Generative Adversarial Nets
'''
...
# it was important to make sure that the discriminator is more powerful than the generator
...
class GAN(object):
    def __init__(self, params):
        ...
        # the true data distribution (self.x) and the generated samples (self.z).

        # Here we create two copies of the discriminator network
        # that share parameters, as you cannot use the same network with different inputs in TensorFlow.
